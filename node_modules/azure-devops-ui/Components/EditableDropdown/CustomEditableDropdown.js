...
import { isListBoxItemVisible, renderListBoxCell } from '../../ListBox';
...
var CustomEditableDropdown = /** @class */ (function (_super) {
    ...
    function CustomEditableDropdown(props) {
        ...
        _this.onCollapse = function () {
            var _a = _this.props, allowFreeform = _a.allowFreeform, autoAccept = _a.autoAccept, onCollapse = _a.onCollapse, onTextChange = _a.onTextChange, onValueChange = _a.onValueChange, showTree = _a.showTree, text = _a.text;
            if (onCollapse) {
                onCollapse();
            }
        ...
        _this.renderExpandable = function (props) {
            return (React.createElement(Observer, { focusedIndex: _this.focusedIndex, selectedText: _this.props.selectedText, text: _this.props.text }, function (observerProps) {
                var _a = _this.props, allowTextSelection = _a.allowTextSelection, onTextChange = _a.onTextChange;
                var focusedIndex = observerProps.focusedIndex, selectedText = observerProps.selectedText, text = observerProps.text;
                var activeId;
                ...
                var expandableProps = __assign(__assign({}, props), { ariaActiveDescendant: activeId, editable: true, showPrefix: text ? false : true, blurDismiss: true, onChange: onTextChange, onKeyDown: _this.onKeyDown, value: value });
    ...
    CustomEditableDropdown.prototype.render = function () {
        var _this = this;
        var _a = this.props, actions = _a.actions, allowTextSelection = _a.allowTextSelection, ariaLabel = _a.ariaLabel, calloutContentClassName = _a.calloutContentClassName, className = _a.className, disabled = _a.disabled, filterByText = _a.filterByText, getUnselectableRanges = _a.getUnselectableRanges, noItemsText = _a.noItemsText, onToggle = _a.onToggle, selectedText = _a.selectedText, showTree = _a.showTree, text = _a.text, minCalloutWidth = _a.minCalloutWidth;
    ...
    CustomEditableDropdown.prototype.getFocusedIndex = function () {
        ...
        for (var i = 0; i < currentFocusedIndex; i++) {
