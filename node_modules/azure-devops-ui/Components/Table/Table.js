...
var TableHeaderCell = /** @class */ (function (_super) {
    ...
    TableHeaderCell.prototype.render = function () {
        ...
        return (React.createElement(FocusZoneContext.Consumer, null, function (cellContext) {
            ...
            return (React.createElement("th", { role: "columnheader", "aria-colindex": colIndex, "aria-labelledby": childId, "aria-readonly": "true", "aria-sort": sortProps.sortOrder !== undefined
                    ? sortProps.sortOrder === SortOrder.ascending
                        ? "ascending"
                        : "descending"
                    : undefined, className: css(column.headerClassName, "bolt-table-header-cell", "col-header-" + columnIndex, actionable && "bolt-table-header-cell-actionable"), "data-column-index": columnIndex, "data-focuszone": actionable && css(isFirstActionableHeader && focuszoneId, cellContext.focuszoneId), ref: _this.element, tabIndex: actionable || sizer ? 0 : -1 },
...
export function TableRow(props) {
    var onFocus = function (event) {
        ...
        if (props.details.ariaSetSize) {
            if (props.linkProps) {
                Utils_Accessibility.announce(format(Resources.ClickableRowAnnouncementWithSize, rowNumber), true);
            }
            else if (role == "option") {
